...
function stringifyDependencyPath(rawPath, originalPath, options, moduleOptions) {
    ...
    var tree = options.tree, global = options.global, cwd = options.cwd, resolution = options.resolution, name = options.name, prefix = options.prefix, readFiles = options.readFiles, imported = options.imported, meta = options.meta, emitter = options.emitter;
